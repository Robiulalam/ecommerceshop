	<div class="agileits_header">
		<div class="container">
			...
			<div class="product_list_header">  
						...
						<a href="{{ url('/show-cart') }}" title="Show Cart"><h2 class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></h2></a>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="{{ url('category-view/'.$allPublishedCategory->id) }}" class="act">{{$allPublishedCategory->category_name}}</a></li>
									@endforeach	
									<!-- Mega Menu -->
									<!-- <li class="dropdown">
